...
[System.Serializable]
public class MonsterFactory : ObjectFactory<Monster>
{
    ...
    public override Monster CreateGameObject(int id)
    {
        Monster monster = MonoBehaviour.Instantiate(prefabs[id], object_container[id]);
        return monster;
    }
}
